package com.codeancy.translator.android.voice_to_text.data
...
import com.codeancy.translator.core.domain.util.CommonMutableStateFlow
...
import com.codeancy.translator.voice_to_text.domain.VoiceToTextParserState
...
class AndroidVoiceToTextParser(
    ...
    override fun startListening(languageCode: String) {
        ...
        if (!SpeechRecognizer.isRecognitionAvailable(app)) {
            _state.update {
                it.copy(error = app.getString(R.string.error_speech_recognization_unavailble))
            }
            return
        }
        val intent = Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH).apply {
            ...
            putExtra(RecognizerIntent.EXTRA_PROMPT,"Please speak clearly")
        }
